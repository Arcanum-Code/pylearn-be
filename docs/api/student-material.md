...
Retrieves a unified chronological timeline (`items`) of both materials and quizzes for a group, formatted specifically for the student course portal.

```
GET /api/student/groups/mahasiswa/{groupId}
```
